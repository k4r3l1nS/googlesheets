package io.dtechs.googlesheets.config.credentials;
...
public class CredentialService {
    ...
    public Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
        ...
        InputStream in = SheetClient.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
        ...
        // Конфигурация потока и запуск запроса авторизации
